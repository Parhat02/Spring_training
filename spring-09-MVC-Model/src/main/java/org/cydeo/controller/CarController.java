...
public class CarController {
    ...
    @RequestMapping("/info3") //This is matching based on the name
    ...
    @RequestMapping("/info/{make}/{year}") //This is matching based on the position
    public String carInfo4(@PathVariable String make, @PathVariable int year){
