...
public interface DepartmentRepository extends JpaRepository<Department, String> {
    ...
    List<Department> findByDivisionIs(String division); //same function with findByDivision
    List<Department> findByDivisionEquals(String division); //same function with findByDivision
